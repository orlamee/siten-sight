    ...
    <section className="py-20">
      <div className="container mx-auto px-6 md:px-10">
          ...
          {learningItems.map((item, index) => (
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <a
                  href="#"
                  className="mt-auto text-[#c3590e] font-medium flex items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-xs"
                >
                  Explore
                  <svg
        ...
        <div className="mt-16 text-center">
          <button className="px-8 py-3 bg-[#c3590e] text-white rounded-full font-medium hover:bg-[#6b615b] transition flex items-center mx-auto">
